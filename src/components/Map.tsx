...
const Map = ({ data }) => {
    ...
    return (
        <MapContainer className={styles.container} attributionControl={false} center={[46.227638, 2.213749]} zoom={6} minZoom={3} maxZoom={15} scrollWheelZoom={true} zoomControl={false} ref={mapRef}>
            <TileLayer
